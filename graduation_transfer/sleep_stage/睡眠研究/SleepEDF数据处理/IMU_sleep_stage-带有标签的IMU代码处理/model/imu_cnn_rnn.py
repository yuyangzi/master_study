...
class SleepCNNRNN(nn.Module):
    def __init__(self, input_dim, num_classes, rnn_hidden_size=64, rnn_num_layers=2):
    ...
    def forward(self, x):
        ...
        # 转换为RNN输入格式: (batch_size, seq_len, input_size)
...
model = SleepCNNRNN(input_dim, num_classes, rnn_hidden_size=64, rnn_num_layers=2)
